...
class Bridges extends Component
{
    ...
    public $bridges = [];
    public $selectedCollection = 'ReferenceBridge';
    public $perPage = 10;
    public $query = '';
    ...
    {
        return view('livewire.bridges.bridges');
    }
    ...
    public function loadBridges()
    {
        ...
        $fields = [
            'BridgeID','ReferenceName','WaterLevel'
        ];
        ...
        foreach ($documents as $doc) {
            ...
            $data['name_lower_case'] = strtolower($data['ReferenceName'] ?? '');

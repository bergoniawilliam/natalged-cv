<div class="p-6 max-w-xl mx-auto bg-white shadow rounded">
    ...
    <h2 class="text-xl font-bold mb-5">Edit Affected Bridge</h2>
    ...
    <form wire:submit.prevent="update">
        ...
        <div class="mb-4">
            ...
            @error('bridgename') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text"
                ...
                class="w-full border rounded px-3 py-2">
            @error('bridgeAge') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text"
                ...
                class="w-full border rounded px-3 py-2">
            @error('bridgeLength') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text"
                ...
                class="w-full border rounded px-3 py-2">
            @error('longtitude') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
        </div>

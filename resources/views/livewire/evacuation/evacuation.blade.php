<div>
    ...
    <div x-data=""
        x-on:triggerDeleteConfirmation.window="if(confirm('Are you sure you want to delete this evacaution?')) { @this.call('deleteBridge') }"
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center py-4">No evacuation found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

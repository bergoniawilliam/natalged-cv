        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
            <thead class="bg-gray-50 dark:bg-zinc-600">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-sm font-medium text-zinc-900 dark:text-zinc-100">Bridge</th>
                    <th class="px-4 py-2 text-left text-sm font-medium text-zinc-900 dark:text-zinc-100">Water Level</th>
                    <th class="px-4 py-2 text-left text-sm font-medium text-zinc-900 dark:text-zinc-100">Affected</th>
            ...
            <tbody>
                @forelse($this->collections() as $index =>$collection)
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm">
                            {{ $collection['bridge_name'] ?? 'NA' }}
                        </td>
                        <td class="px-4 py-2 text-sm">
                            {{ $collection['water_lvl'] ?? 'NA' }}
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center py-4">No roads found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

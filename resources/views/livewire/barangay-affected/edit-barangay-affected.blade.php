<div class="p-6 max-w-xl mx-auto bg-white shadow rounded">
    ...
    <h2 class="text-xl font-bold mb-5">Edit Barangay</h2>

    <form wire:submit.prevent="update">

        <div class="mb-4">
            <label class="block mb-1 font-medium">Barangay Name</label>
            <input type="text" wire:model="barangayName" class="w-full border rounded px-3 py-2">
        </div>

        <div class="mb-4">
            <label class="block mb-1 font-medium">Families Affected</label>
            <input type="text" wire:model="familiesAffected" class="w-full border rounded px-3 py-2">
        </div>

        <div class="mb-4">
            <label class="block mb-1 font-medium">Latitude</label>
            <input type="text" wire:model="latitude" class="w-full border rounded px-3 py-2">
        </div>

        <div class="mb-4">
            <label class="block mb-1 font-medium">Longitude</label>
            <input type="text" wire:model="longtitude" class="w-full border rounded px-3 py-2">
        </div>

        <div class="flex justify-end gap-2 mt-5">
            <flux:button href="{{ route('barangay-affected') }}" variant="outline">
                Cancel
            </flux:button>

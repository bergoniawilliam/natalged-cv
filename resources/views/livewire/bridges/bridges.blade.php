            ...
            <tbody>
                @forelse($this->collections() as $index =>$collection)
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm text-zinc-900 dark:text-zinc-100">{{ $collection['BridgeID'] ?? 'NA' }}</td>
                        <td class="px-4 py-2 text-sm text-zinc-900 dark:text-zinc-100">{{ $collection['ReferenceName'] ?? 'NA' }}</td>
                        <td class="px-4 py-2 text-sm text-zinc-900 dark:text-zinc-100">{{ $collection['WaterLevel'] ?? 'NA' }}</td>
                                    ...
                                    <div class="space-y-6">
                                        <div>
                                            ...
                                            <flux:text class="mt-2">
                                                ...
                                                Name: {{ $collection['ReferenceName'] ?? "<span class='italic text-gray-400'>No specified Name </span>" }} <br>

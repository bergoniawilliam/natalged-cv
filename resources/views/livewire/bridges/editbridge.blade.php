<div class="p-6 max-w-xl mx-auto bg-white shadow rounded">
    ...
    <h2 class="text-xl font-bold mb-5">Edit Bridge</h2>

    <form wire:submit.prevent="update">

        {{-- Reference Name --}}
        <div class="mb-4">
            <label class="block mb-1 font-medium">Reference Name</label>
            <input 
                type="text" 
                wire:model="ReferenceName"
        ...
        {{-- Bridge ID --}}
        <div class="mb-4">
            <label class="block mb-1 font-medium">Bridge ID</label>
            <input 
                type="text" 
                wire:model="BridgeID"
                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200"
        ...
        {{-- WaterLevel --}}
        <div class="mb-4">
            <label class="block mb-1 font-medium">WaterLevel</label>
            <textarea 
                wire:model="WaterLevel"
                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200"
                rows="3"
